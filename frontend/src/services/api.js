...
export const createShareLink = (recordId) => API.post('/share/create', { record_id: recordId })
export const getMyShareLinks = () => API.get('/share/my-links')
export const revokeShareLink = (token) => API.delete('/share/' + token)
export const getSharedRecord = (token) => API.get('/share/' + token)
export const getActivityLog = () => API.get('/activity/')
export const logActivity = (action_type, description) => API.post('/activity/', { action_type, description })